...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "secondary", size = "md", loading, leftIcon, rightIcon, children, className, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-gradient-to-br from-indigo-500 to-indigo-600 text-white border-transparent shadow-[0_2px_8px_rgba(99,102,241,0.35)] hover:shadow-[0_4px_16px_rgba(99,102,241,0.45)] hover:-translate-y-0.5",
      ...
      ghost: "bg-transparent border-transparent text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800",
